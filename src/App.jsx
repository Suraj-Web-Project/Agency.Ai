  ...
  return (
    <div className='dark:bg-black relative'>
      ...
      <Footer theme={theme} />
       ...
       {/* Custom Cursor Ring */}
       <div ref={outlineRef} className='fixed top-0 left-0 w-10 h-10 rounded-full border border-primary pointer-events-none z-[9999]' style={{transition: 'transform 0.1s ease-out'}}>
